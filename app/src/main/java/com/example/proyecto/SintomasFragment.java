 ...
 */
public class SintomasFragment extends Fragment  implements Response.Listener<JSONObject>,Response.ErrorListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_sintomas, container, false);
        codigo = root.findViewById(R.id.codigo);
        descripcion = root.findViewById(R.id.descripcion);
        guardar = root.findViewById(R.id.guardar_Sintoma);
